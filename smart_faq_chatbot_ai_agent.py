# -*- coding: utf-8 -*-
"""# Smart FAQ Chatbot
### A retrieval-based chatbot using TF-IDF vectorization and cosine similarity

This project implements an intelligent FAQ chatbot that matches user queries 
to a knowledge base using NLP techniques. Key concepts demonstrated:
